package com.hexicube.solapple.lib;
...
public final class Localization {
	...
	/** e.g. keyString("tooltip", "eaten_status.not_eaten_1") -> "tooltip.solapple.eatenStatus.not_eaten_1") */
	public static String keyString(String domain, String path) {
		return domain + "." + SOLApple.MOD_ID + "." + path;
	}
